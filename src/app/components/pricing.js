...
const PricingSection = () => {
  return (
    <>
      <div class="max-w-7xl mx-auto py-24 px-4 bg-indigo-100 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl sm:leading-none sm:tracking-tight lg:text-5xl">
