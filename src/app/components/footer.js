...
//     >
//       <h2 id="footer-heading" classNameName="sr-only">
//         Footer
//       </h2>
//       <div classNameName="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
//         <div classNameName="xl:grid xl:grid-cols-3 xl:gap-8">
//           <div classNameName="space-y-8 xl:col-span-1">
//             <p classNameName="text-gray-800 text-base">SiteGenie</p>
//             <p classNameName="text-gray-800 text-base">
//               Instantly answer your visitors' questions with a personalized
//               chatbot trained on your website content.
//             </p>
//           </div>
//           <div classNameName="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
//             <div classNameName="md:grid md:grid-cols-2 md:gap-8">
//               <div>
//                 <h3 classNameName="text-sm font-bold text-blue-700 tracking-wider uppercase">
//                   Solutions
//                 </h3>
//                 <ul role="list" classNameName="mt-4 space-y-4">
//                   {navigation.solutions.map((item) => (
//                     <li key={item.name}>
//                       <a
//                         href={item.href}
//                         classNameName="text-base text-gray-800 hover:text-gray-500"
//                       >
//                         {item.name}
//                       </a>
//                     </li>
...
//                 </ul>
//               </div>
//               <div classNameName="mt-12 md:mt-0">
//                 <h3 classNameName="text-sm font-bold text-blue-700 tracking-wider uppercase">
//                   Support
//                 </h3>
//                 <ul role="list" classNameName="mt-4 space-y-4">
...
//                       <a
//                         href={item.href}
//                         classNameName="text-base text-gray-800 hover:text-gray-600"
//                       >
//                         {item.name}
//                       </a>
//                     </li>
...
//         <div classNameName="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
//           <div classNameName="flex space-x-6 md:order-2">
//             {navigation.social.map((item) => (
//               <a
//                 key={item.name}
//                 href={item.href}
//                 classNameName="text-gray-800 hover:text-gray-600"
//               >
//                 <span classNameName="sr-only">{item.name}</span>
//                 <item.icon classNameName="h-6 w-6" aria-hidden="true" />
//               </a>
//             ))}
//           </div>
//           <p classNameName="mt-8 text-base text-gray-800 md:mt-0 md:order-1">
//             &copy; 2023 SiteGenie. All rights reserved.
//           </p>
//         </div>
//       </div>
//     </footer>
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8 xl:col-span-1">
              ...
              <div className="flex space-x-6">
                <a
                  href="https://www.notion.so/24f1fbce496a4afabc2a28ce8a0fc460?v=d46dc51ebf5f4f8d9156862676b627af"
